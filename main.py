...
def main():
    ...
    options = ["Display longest movie", 
                ...
                "Add movie",
                "Show movies",
                "Display sorted dictionary by directors first name alphabetically",
                "Exit"
                ]
    while True:
        print("          MAIN MENU" + "\n")
        ...
        if option == "16":
            ...
            if int(selection) >= 1 and int(selection) <= 11:
        ...
        if option == "18":
            ...
            input("Press ENTER to continue!")              
        if option == "19":
            result = statistics.sort_dictionary_by_directors_last_name_alphabetically(all_movies)
            print("Sorted dictionary by directors last name alphabetically")
            display.show_movie(result)
            input("Press ENTER to continue!")
        if option == "20":
            break
        else:
